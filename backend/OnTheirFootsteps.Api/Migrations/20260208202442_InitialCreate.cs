        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredLanguage = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "en"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArabicName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Slug = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ArabicDescription = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PageViews_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    EraId1 = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characters_Categories_CategoryId1",
                        column: x => x.CategoryId1,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Characters_Eras_EraId",
                        column: x => x.EraId,
                        principalTable: "Eras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characters_Eras_EraId1",
                        column: x => x.EraId1,
                        principalTable: "Eras",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharacterLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterLikes_Characters_CharacterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterViews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharacterViews_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterViews_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MimeType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProgress_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterLikes_CharacterId",
                table: "CharacterLikes",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterLikes_UserId",
                table: "CharacterLikes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "ix_characters_category",
                table: "Characters",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Characters_CategoryId1",
                table: "Characters",
                column: "CategoryId1");

            migrationBuilder.CreateIndex(
                name: "ix_characters_era",
                table: "Characters",
                column: "EraId");

            migrationBuilder.CreateIndex(
                name: "IX_Characters_EraId1",
                table: "Characters",
                column: "EraId1");

            migrationBuilder.CreateIndex(
                name: "ix_characters_featured",
                table: "Characters",
                column: "IsFeatured");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterViews_CharacterId",
                table: "CharacterViews",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterViews_UserId",
                table: "CharacterViews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageViews_UserId1",
                table: "PageViews",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_CharacterId",
                table: "UserProgress",
                column: "CharacterId");
